  ...
  return (
    ...
    <div className="bg-boxdark text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden border max-w-[1000px]">
        <div className="md:flex w-full">
         ...
         <Image alt='compass' className='hidden dark:block h-5/6 w-full' src='/CompassWhite.png' width="1500" height="1500" />
         </motion.div>
                <motion.div
                animate={{ rotate: 20 }}
                transition={{ 
         ...
         <Image alt='compass' className='bl dark:hidden h-5/6 w-full' src='/Compassblack.png' width="1500" height="1500" />
         </motion.div>
            </div>
            <form className="w-full md:w-1/2 py-10 px-5 md:px-10 dark:bg-boxdark bg-white" onSubmit={handleSubmit}>
            ...
            <div className="flex -mx-3">
                <div className="w-full px-3 mb-5">
                    <label className="text-xs font-bold px-1 text-black dark:text-[#e9e9e8]">Name</label>
                    {nameError && <p className='text-red-500 text-xs px-1'>{nameError}</p>}
                    <div className="flex">
                        <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                            <svg viewBox="0 0 24 24"  height='25' fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M12 12C14.7614 12 17 9.76142 17 7C17 4.23858 14.7614 2 12 2C9.23858 2 7 4.23858 7 7C7 9.76142 9.23858 12 12 12Z" stroke="#292D32" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"></path> <path d="M20.5899 22C20.5899 18.13 16.7399 15 11.9999 15C7.25991 15 3.40991 18.13 3.40991 22" stroke="#292D32" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"></path> </g></svg>
                            </div>
                        <input 
                        type="name" 
                        name="name" 
                ...
                <div className="flex -mx-3">
                    ...
                    <div className="flex -mx-3">
                        <div className="w-full px-3 mb-12">
                            <label className="text-xs font-bold px-1 text-black dark:text-[#e9e9e8]">Password</label>
                            {passwordError && <p className='text-red-500 text-xs px-1'>{passwordError}</p>}
                            <div className="flex">
                                <div className="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" height='25'><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M21 8.5V6C21 4.89543 20.1046 4 19 4H5C3.89543 4 3 4.89543 3 6V11C3 12.1046 3.89543 13 5 13H10.875M19 14V12C19 10.8954 18.1046 10 17 10C15.8954 10 15 10.8954 15 12V14M14 20H20C20.5523 20 21 19.5523 21 19V15C21 14.4477 20.5523 14 20 14H14C13.4477 14 13 14.4477 13 15V19C13 19.5523 13.4477 20 14 20Z" stroke="#000000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path> <circle cx="7.5" cy="8.5" r="1.5" fill="#000000"></circle> <circle cx="12" cy="8.5" r="1.5" fill="#000000"></circle> </g></svg>
                                    </div>
                                    <input 
                                    type="password" 
                                    name="password" 
