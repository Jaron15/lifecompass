        ...
        <div className="md:flex w-full">
         ...
         <Image className='bl dark:hidden h-5/6 w-full' src='/Compassblack.png' width="1500" height="1500" />
            ...
            <div className="flex -mx-3">
                ...
                <div className="flex -mx-3">
                    <div className="w-full px-3 mb-5">
                        <label for="" className="text-xs font-bold px-1 text-black dark:text-[#e9e9e8]">Email</label>
                    ...
                    <div className="flex -mx-3">
                        <div className="w-full px-3 mb-12">
                            <label for="" className="text-xs font-bold px-1 text-black dark:text-[#e9e9e8]">Password</label>
