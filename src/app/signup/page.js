            ...
            <div className="flex -mx-3">
                <div className="w-full px-3 mb-5">
                    ...
                    <div className="flex">
                        ...
                        <input type="text" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 outline-none border-[#E2E8F0]  dark:focus:border-primary focus:border-black" placeholder="John" />
                    </div>
                </div>
                ...
                <div className="flex -mx-3">
                    <div className="w-full px-3 mb-5">
                        ...
                        <div className="flex">
                            ...
                            <input type="email" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 outline-none border-[#E2E8F0]  dark:focus:border-primary focus:border-black" placeholder="johnsmith@example.com" />
                        </div>
                    </div>
                    </div>
                    <div className="flex -mx-3">
                        <div className="w-full px-3 mb-12">
                            ...
                            <div className="flex">
                                ...
                                <input type="password" className="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 outline-none border-[#E2E8F0]  dark:focus:border-primary focus:border-black" placeholder="************" />
                            </div>
                        </div>
                    </div>
                    <div className="flex -mx-3">
