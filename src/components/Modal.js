  ...
  return (
    ...
    >
      <div className="flex items-end justify-center min-h-screen">
        ...
        <div className="bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full border border-red-500">
